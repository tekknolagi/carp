...
short int carp_stack_init (carp_stack *, carp_value *, carp_value);
short int carp_stack_empty (carp_stack *);
short int carp_stack_full (carp_stack *);
short int carp_stack_push (carp_stack *, carp_value);
short int carp_stack_pop (carp_stack *, carp_value *);
short int carp_stack_peek (carp_stack *, carp_value *);
